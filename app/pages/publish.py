...
def publish_page() -> rx.Component:
                    ...
                    rx.el.div(
                                ...
                                form_field(
                                    ...
                                    rx.el.input(
                                        ...
                                        class_name=rx.cond(
                                            ...
                                            "w-full px-4 py-2.5 bg-white border border-red-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all",
                                            "w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 transition-all",
                                        ),
                        ...
                        form_field(
                            ...
                            rx.el.input(
                                ...
                                class_name="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 transition-all",
                        ...
                        form_field(
                            ...
                            rx.el.textarea(
                                ...
                                rows=3,
                                class_name="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 transition-all resize-y",
                        ...
                        rx.el.div(
                            rx.el.h2(
                                "Schema Definition",
                                class_name="text-lg font-semibold text-gray-900 mb-4 mt-8 pb-2 border-b border-gray-100",
                            ),
                            form_field(
                                "Content (JSON/YAML)",
                                rx.el.div(
  ...
  "fields": [...]
                                        ...
                                        class_name="w-full h-80 px-4 py-4 bg-slate-900 text-slate-50 font-mono text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500 transition-all leading-relaxed",
                                        spellcheck=False,
                        ...
                        rx.el.div(
                            rx.el.button(
                                ...
                                type="button",
                                class_name="px-6 py-2.5 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 focus:ring-4 focus:ring-gray-100 transition-all",
                            ),
                            rx.el.button(
                                rx.cond(
                            ...
                            class_name="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-gray-100",
                        ),
                    ),
                    class_name="bg-white p-6 md:p-8 rounded-xl border border-gray-200 shadow-sm",
                ),
